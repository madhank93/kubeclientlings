...
func main() {
	...
	// The object is stuck terminating because its finalizer is still there.
	// Clear the finalizer list (set it to nil) before Update — the WaitFor
	// below only passes once the object is actually gone.
