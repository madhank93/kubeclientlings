...
func main() {
	...
	// Handler registered, informer configured... and then nothing. The
	// factory was never started and the cache never synced, so the watch
	// below waits on a channel nobody will ever send to.
