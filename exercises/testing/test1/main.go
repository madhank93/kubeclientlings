...
func main() {
	...
	// The pod was seeded in "demo", but this asks the tracker for it in
	// "default". The tracker keys by namespace/name, so this is a plain
	// NotFound — query the namespace you actually seeded.
	got, err := cs.CoreV1().Pods("default").Get(ctx, "seeded", metav1.GetOptions{})
	if err != nil {
